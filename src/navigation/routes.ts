...
export const APP_ROUTE_IDS = Object.freeze({
    ...
    quotes: 'quotes',
    sketch: 'sketch',
    sketchVisualization: 'sketch-visualization',
    sketch3dPrototype: 'sketch-3d-prototype',
    inventory: 'inventory',
...
export const APP_PATHS: Record<AppRouteId, string> = Object.freeze({
    ...
    [APP_ROUTE_IDS.sketchVisualization]: '/sketch/3d',
    [APP_ROUTE_IDS.sketch3dPrototype]: '/sketch/3d-prototype',
...
const ROUTE_ACCESS: Record<AppRouteId, AppRouteAccess> = {
    ...
    [APP_ROUTE_IDS.sketch]: 'sketch',
    [APP_ROUTE_IDS.sketchVisualization]: 'sketch',
    [APP_ROUTE_IDS.sketch3dPrototype]: 'sketch',
